...
\small
\centering
\caption{Comparison of Bio-PN tools and frameworks}
\label{tab:tool_comparison}
\begin{tabular}{@{}lcccc@{}}
\toprule
\textbf{Feature} & \textbf{Snoopy} & \textbf{Cell Ill.} & \textbf{COPASI} & \textbf{SHYpn} \\
\midrule
Continuous PNs & \cmark & \cmark & --- & \cmark \\
Stochastic PNs & \cmark & \cmark & --- & \cmark \\
Test/inhibitor arcs & \cmark & \cmark & --- & \cmark \\
SBML import & Partial & Partial & \cmark & \cmark \\
Weak independence & --- & --- & --- & \cmark \\
Parallel simulation & --- & --- & --- & \cmark \\
Mass balance check & --- & --- & --- & \cmark \\
Formula tracking & --- & --- & --- & \cmark \\
\bottomrule
\end{tabular}
\end{table}
