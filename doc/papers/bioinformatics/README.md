...
- `paper.tex` - Main LaTeX document (two-column format)
- `references.bib` - BibTeX bibliography with all citations
- `bioinfo.cls` - Custom class file mimicking Oxford Bioinformatics style
- `Makefile` - Build automation for compiling the paper
- `DRAFT_PAPER.md` - Original markdown draft (for reference)
