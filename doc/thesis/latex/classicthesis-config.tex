...
\PassOptionsToPackage{
  ...
  beramono=false,    % toggle a nice monospaced font (w/ bold) - DISABLED FOR NOW
...
% ********************************************************************
% Additional packages for biological Petri nets thesis
% ********************************************************************
\usepackage{amssymb}                    % Additional math symbols
\usepackage{amsthm}                     % Theorem environments
\usepackage{booktabs}                   % Professional quality tables
\usepackage[version=4]{mhchem}          % Chemical formulas and equations
\usepackage{tikz}                       % Diagrams and Petri nets
\usetikzlibrary{arrows.meta}            % Better arrow styles
\usetikzlibrary{positioning}            % Relative positioning
\usetikzlibrary{petri}                  % Petri net specific elements
\usetikzlibrary{shapes}                 % Additional shapes
...
% Unicode character support for subscripts and Greek letters
...
% Symbols for checkmarks and warnings
\usepackage{amssymb}
\usepackage{pifont}
\newcommand{\textwarning}{\ding{73}}
