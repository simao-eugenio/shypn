#!/usr/bin/env python3
"""
Analyze N-Methylation 3 Enhanced Simulation Results
===================================================
Three N-methyl groups macrocycle transport simulation analysis.
"""
...
data_path = Path('workspace/projects/My_Project/drug_discovery/data/n_methylation/sim_nme_normal_3_enhanced.csv')
df = pd.read_csv(data_path)

print("="*80)
print("N-METHYLATION 3 ENHANCED SIMULATION ANALYSIS")
print("="*80)
print(f"\nData file: {data_path}")
...
fig.suptitle('N-Methylation 3 Enhanced - Comprehensive Analysis', fontsize=16, fontweight='bold')
...
# Save figure
output_path = Path('nme_3_comprehensive_analysis.png')
...
summary_path = Path('nme_3_summary_statistics.csv')
