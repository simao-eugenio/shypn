#!/usr/bin/env python3
"""
Comprehensive analysis of N-Me 6 tumor simulation data.
Analyzes macrocycle transport dynamics with six N-methyl groups in tumor microenvironment.
Expected to show optimal balance in normal cells - tumor comparison is critical.
"""
...
# Configuration
DATA_FILE = Path("workspace/projects/My_Project/drug_discovery/data/n_methylation/sim_nme_tumor_6_enhanced.csv")
OUTPUT_STATS = Path("tumor_nme_6_summary_statistics.csv")
OUTPUT_PLOT = Path("tumor_nme_6_comprehensive_analysis.png")
...
def create_comprehensive_plot(df, metrics):
    ...
    fig.suptitle('N-Me 6 (Optimal in Normal) Tumor Simulation - Comprehensive Analysis', 
...
def main():
    ...
    print("=" * 80)
    print("N-Me 6 (Optimal Candidate) TUMOR Simulation Analysis")
    print("=" * 80)
