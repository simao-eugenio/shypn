...
**⚠️ For Developers Only**: These scripts are for internal development, debugging, and testing.
...
This directory contains development utilities organized by purpose:

- **`debug/`** - Debugging and diagnostic scripts
- **`demo/`** - Demo and example scripts  
- **`test/`** - Test generators and validation
- **`helpers/`** - Miscellaneous helper scripts
