#!/usr/bin/env python3
"""
Analyze N-Methylation 1 Enhanced Simulation Results
===================================================
Single N-methyl group macrocycle transport simulation analysis.
"""
...
data_path = Path('workspace/projects/My_Project/drug_discovery/data/n_methylation/sim_nme_normal_1_enhanced.csv')
df = pd.read_csv(data_path)

print("="*80)
print("N-METHYLATION 1 ENHANCED SIMULATION ANALYSIS")
print("="*80)
print(f"\nData file: {data_path}")
...
fig.suptitle('N-Methylation 1 Enhanced - Comprehensive Analysis', fontsize=16, fontweight='bold')
...
# Save figure
output_path = Path('nme_1_comprehensive_analysis.png')
...
summary_path = Path('nme_1_summary_statistics.csv')
