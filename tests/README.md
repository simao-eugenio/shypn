...
**Total Tests:** 292+ Python tests + 9 shell scripts

This directory contains all test scripts organized by functional category for easier navigation and maintenance.

---

## 🎯 Recently Added Tests (February 2026)

### **test_event_cache_invalidation.py**
Validates event-driven cache invalidation system.

**Tests:**
- ModelRepository subscribes to 'file.saved' event
- Cache invalidation on DocumentModel.save_to_file()
- EventBus emission and handler execution

**Usage:**
```bash
pytest tests/test_event_cache_invalidation.py -v
```
...
### **test_adaptive_molecule_threshold.py**
Tests adaptive transition molecule counting for threshold behavior.

**Tests:**
- Adaptive transition enablement logic
- Molecule count threshold detection
- Signal hierarchy interaction with adaptive transitions

**Usage:**
```bash
pytest tests/test_adaptive_molecule_threshold.py -v
```

---

## Directory Structure (December 2025)

### Major Test Categories

#### UI & Components (39 tests) - `ui_components/`
Panel, palette, menu, dialog, button, and widget tests

#### Simulation Engine (29 tests) - `simulation/`
Stochastic simulation, firing policies, time handling

#### Arc System (29 tests) - `arcs/`
Arc types, transformations, rendering, hit detection

#### Viability Analysis (20 tests) - `viability/`
Viability computation, visualization, automation

#### Analysis Tools (16 tests) - `analysis/`
Heuristics, locality, enrichment, stoichiometry

#### Pathways (15 tests) - `pathway/`
Pathway operations and panel integration

#### Integration Tests (14 tests) - `integration/`
End-to-end and hybrid integration tests

#### Rendering (13 tests) - `rendering/`
Canvas rendering, drawing, visual output

#### Topology (13 tests) - `topology/`
Network topology analysis, SCC, hub detection

#### KEGG Integration (13 tests) - `kegg_integration/`
KEGG pathway import and conversion

#### Testing BIOpn (13 tests) - `testing_BIOpn/`
BIOpn-specific model tests

### Supporting Categories (50+ more)

- **file_operations/** (10) - File I/O, save/load
- **miscellaneous/** (10) - Various utility tests
- **utilities/** (7) - Helpers, caching
- **import_path/** (7) - Import handling
- **sbml/** (6) - SBML conversion
- **phase_tests/** (6) - Development phases
- **layout/** (6) - Layout algorithms
- **kinetics/** (6) - Rate functions
- **examples/** (6) - Example models
- **biomodels/** (6) - BioModels tests
- **algorithms_specific/** (6) - Algorithm implementations
- Plus 30+ more specialized categories...

## Test History

**November 2025**: Property Dialog Tests ✅ 34/34 passing (100%)
...
- ✅ 113 diagnostic/bug-fix tests archived to `/archive/diagnostic_tests/`
- ✅ 290+ active tests organized into 50+ functional categories
- ✅ Root directory cleaned (no flattened test files)
- ✅ Clear separation by component and functionality

## Running Tests

Individual categories can be tested independently:
```bash
# Run all arc tests
python -m pytest tests/arcs/
...
When adding new tests, place them in the appropriate category directory. If no suitable category exists, consider creating a new one or placing in `miscellaneous/` with a clear docstring.

## Archived Tests

Diagnostic and bug-specific tests moved to `/archive/diagnostic_tests/` for historical reference (113 files).
