...
def test_place_persistence():
    ...
    # Create a place
    p1 = Place(x=100.0, y=200.0, id="P1", name="P1", label="Input Place")
    p1.set_initial_marking(3)
...
def test_transition_persistence():
    ...
    # Create a transition
    t1 = Transition(x=200.0, y=200.0, id="T1", name="T1", label="Process", horizontal=True)
...
def test_arc_persistence():
    ...
    p1 = Place(x=100.0, y=200.0, id="P1", name="P1")
    t1 = Transition(x=200.0, y=200.0, id="T1", name="T1")
...
def test_complete_network_persistence():
    ...
    p1 = Place(x=100.0, y=200.0, id="P1", name="P1", label="Input")
    p1.set_initial_marking(3)
    
    t1 = Transition(x=200.0, y=200.0, id="T1", name="T1", label="Process")
    
    p2 = Place(x=300.0, y=200.0, id="P2", name="P2", label="Output")
    
    a1 = Arc(source=p1, target=t1, id="A1", name="A1", weight=2)
    a2 = Arc(source=t1, target=p2, id="A2", name="A2", weight=1)
