...
class TransitionPropDialogLoader(GObject.GObject):
    ...
    **DEPRECATED**: This is a compatibility wrapper around TransitionPropertyDialog.
    New code should use TransitionPropertyDialog directly.
    
    This class maintains backward compatibility while delegating to the new
    OOP architecture in shypn.ui.dialogs.transition.
...
# For backward compatibility: expose old long methods as no-ops or delegates
# These are retained to avoid breaking existing code that might call them
