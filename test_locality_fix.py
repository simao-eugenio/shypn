#!/usr/bin/env python3
"""Direct test without going through __init__.py"""

import sys
import os
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'src'))

# Direct file imports to avoid __init__.py
import importlib.util

# Load locality_detector directly
...
# Load locality_analyzer directly
spec2 = importlib.util.spec_from_file_location(
    "locality_analyzer",
    "src/shypn/diagnostic/locality_analyzer.py"
)
