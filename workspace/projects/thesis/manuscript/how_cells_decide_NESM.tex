...
\begin{figure}[!ht]
  ...
  \caption{\textbf{Q1: medium is the commitment gate.}
  (Left) Sporulation fraction for SM ($N_0{=}100\,\mu$M) and CH ($N_0{=}1440\,\mu$M)
  conditions with natural phosphorelay (natural) and abrupt Spo0A$\sim$P
  pulse (abrupt).  (Right) Representative ATP trajectories showing the
  $1.96$~mM commitment floor (dashed) crossed only in SM conditions.
  Sweep F1, run~\texttt{20260702\_171823}, 50~replicates/condition.}
  \label{fig:q1}
\end{figure}
