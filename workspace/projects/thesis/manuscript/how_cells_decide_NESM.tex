...
$M_0$ = initial marking;
$\Phi$ = rate functions;
$C: P \to \text{Compartments}$ = compartment assignment (volume-based concentration conversion, simulation engine);
% [NOTE: C does not appear in Enabled or Firing — simulation-level parameter only]
