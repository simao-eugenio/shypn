...
\begin{figure}[!ht]
  ...
  \caption{\textbf{Q3: nutrient threshold and commitment timing.}
  (Left) Sporulation fraction vs.\ $N_0$ (natural route); $\Nc \approx 1370\,\mu$M
  and bet-hedging window $700$--$1800\,\mu$M shaded.
  (Centre) Mean commitment time increases with $N_0$ (depletion clock).
  (Right) Mean $\sigma_H$ peak decreases monotonically with $N_0$;
  dashed line: $\theta_{\sigma H} = 1.60\,\mu$M.
  Sweep F4, run~\texttt{20260704\_163628}, 200~replicates/condition.}
  \label{fig:q3}
\end{figure}
