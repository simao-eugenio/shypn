...
biological systems; stochastic thermodynamics~\cite{Seifert2012}, which
provides exact trajectory-level entropy production for Markov chains of
any size, offers a principled alternative.
Here we introduce the Stochastic Hybrid Petri Net (SHPN) formalism as the
...
Losick~\cite{Fujita2005} and reveals that the commitment transition is
...
We propose the Stochastic Hybrid Petri Net (SHPN)~\cite{Simao2025} as
this substrate.
...
A Stochastic Hybrid Petri Net is the 13-tuple
\begin{equation}
...
\bibitem{Simao2025}
  Sim\~{a}o, E. (2025).
  Stochastic Hybrid Petri Nets for biological systems: formalism,
