...
The author thanks the members of the UFSC Araranguá campus for providing
the computational environment in which this work was carried out.
GPU simulations were run on an NVIDIA RTX~5060~Ti workstation maintained
by the author.
The author is grateful to the open-source communities behind Python,
NumPy, SciPy, Matplotlib, and \LaTeX{} whose tools underpin all
analysis and typesetting in this manuscript.
[{\itshape Placeholder: add collaborator acknowledgements if applicable.}]

% ─────────────────────────────────────────────────────────────────────────────
\section*{Funding}
% ─────────────────────────────────────────────────────────────────────────────

[{\itshape Placeholder: insert grant numbers and funding agencies (CNPq,
CAPES, FAPESC, or other) once confirmed.}]
This study received no specific funding from commercial entities.
