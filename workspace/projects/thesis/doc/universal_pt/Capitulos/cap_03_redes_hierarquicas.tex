...
a predição genuinamente \emph{ab initio}.
...
essa predição é genuinamente \emph{ab initio}: o limiar de comprometimento
emerge de primeiros princípios termodinâmicos.
