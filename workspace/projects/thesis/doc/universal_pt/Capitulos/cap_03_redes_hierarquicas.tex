...
\begin{figure}[!h]
  ...
  \caption{\textbf{Analogia hidráulica da cascata de preempção SHPN}
    ...
    que \emph{separa} $B_{\mathrm{above}}$ (reservatório: $M(p_s) \geq M_{\mathrm{commit}}$)
    de $B_{\mathrm{below}}$ (região comprometida: $M(p_s) < M_{\mathrm{commit}}$).
...
$\theta_{\mathrm{eff}}$ não é um leito de rio vazio --- é o \textbf{nível de
regime pós-comprometimento}: o nível estável ao qual o sinal retorna após
a cheia de comprometimento, análogo a um rio voltando às suas margens.
