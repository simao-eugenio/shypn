...
\begin{figure}[!h]
  ...
  \caption{\textbf{Analogia hidráulica da cascata de preempção SHPN}
    ...
    A linha tracejada laranja ($\theta_{\mathrm{eff}}$) é o \emph{piso mínimo de bacia} ---
    o nível residual mínimo dentro de $B_{\mathrm{below}}$, atingido quando o disparo
    ocorre exatamente a partir de $M_{\mathrm{commit}}$; se $M(p_s) > M_{\mathrm{commit}}$,
    o residual pós-disparo $M'(p_s) = M(p_s) - W_s > \theta_{\mathrm{eff}}$.
