...
modo a calcular tais limites a partir de princípios primeiros?
...
\textit{B.~subtilis}?'', mas sim ``o formalismo prediz o fenômeno a partir de
princípios primeiros, sem ajuste ao resultado?''. A reprodução pela simulação
