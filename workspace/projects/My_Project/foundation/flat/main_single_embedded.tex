...
\bibitem[Blanchini et~al.(2021)Blanchini, Colaneri, and Valcher]{blanchini2021}
Franco Blanchini, Patrizio Colaneri, and Maria~Elena Valcher.
\newblock Polyhedral lyapunov functions structurally ensure global asymptotic
  stability of dynamical networks if the jacobian is non-singular.
\newblock \emph{Automatica}, 129:\penalty0 109599, 2021.

\bibitem[Chaouiya(2007)]{chaouiya2007}
Claudine Chaouiya.
\newblock Petri net modelling of biological networks.
\newblock \emph{Briefings in Bioinformatics}, 8\penalty0 (4):\penalty0
  210--219, 2007.

\bibitem[Chaouiya et~al.(2006)Chaouiya, Remy, and Thieffry]{chaouiya2006}
Claudine Chaouiya, Elisabeth Remy, and Denis Thieffry.
\newblock Qualitative petri net modelling of genetic networks.
\newblock In \emph{Transactions on Computational Systems Biology VI}, volume
  4220 of \emph{Lecture Notes in Computer Science}, pages 95--112. Springer,
  Berlin, 2006.

\bibitem[Fujita and Losick(2005)]{fujita2005}
Masaya Fujita and Richard Losick.
\newblock Evidence that entry into sporulation in \textit{Bacillus subtilis} is
  governed by a gradual increase in the level and activity of the master
  regulator spo0a.
\newblock \emph{Genes \& Development}, 19\penalty0 (18):\penalty0 2236--2244,
  2005.
\newblock \doi{10.1101/gad.1335705}.

\bibitem[Genovese et~al.(2022)Genovese, Loregian, and Palombi]{genovese2021}
Fabrizio~Romano Genovese, Fosco Loregian, and Daniele Palombi.
\newblock Nets with mana: A framework for chemical reaction modelling.
\newblock In \emph{Proceedings of the 4th International Conference on Applied
  Category Theory (ACT 2021)}, volume 372 of \emph{Electronic Proceedings in
  Theoretical Computer Science}, pages 185--207. Open Publishing Association,
  2022.
\newblock \doi{10.4204/EPTCS.372.14}.
\newblock Originally published as arXiv:2101.06234.
...
\bibitem[Heiner et~al.(2008)Heiner, Gilbert, and Donaldson]{heiner2008}
Monika Heiner, David Gilbert, and Robin Donaldson.
\newblock Petri nets for systems and synthetic biology.
\newblock \emph{Lecture Notes in Computer Science}, 5016:\penalty0 215--264,
  2008.

\bibitem[Jia et~al.(2025)]{jia2025}
Wei Jia et~al.
\newblock A categorical framework for probabilistic gene regulatory networks.
\newblock \emph{arXiv preprint arXiv:2508.13208}, 2025.

\bibitem[Johnston and Avram(2025)]{johnston2025}
Matthew~D Johnston and Florin Avram.
\newblock Boundary analysis of chemical reaction networks using siphons.
\newblock \emph{arXiv preprint arXiv:2506.01606}, 2025.

\bibitem[Koch et~al.(2011)Koch, Reisig, and Schreiber]{koch2011}
Ina Koch, Wolfgang Reisig, and Falk Schreiber.
\newblock \emph{Modeling in Systems Biology: The Petri Net Approach}.
\newblock Springer, London, 2011.

\bibitem[Murata(1989)]{murata1989}
Tadao Murata.
\newblock Petri nets: Properties, analysis and applications.
\newblock \emph{Proceedings of the IEEE}, 77\penalty0 (4):\penalty0 541--580,
  1989.

\bibitem[Petri(1962)]{petri1962}
Carl~Adam Petri.
\newblock Kommunikation mit automaten.
\newblock \emph{Doctoral dissertation, University of Bonn}, 1962.

\bibitem[Reddy et~al.(1993)Reddy, Mavrovouniotis, and Liebman]{reddy1993}
Venkatramana~N Reddy, Michael~L Mavrovouniotis, and Michael~N Liebman.
\newblock Petri net representations in metabolic pathways.
\newblock \emph{Proceedings of the International Conference on Intelligent
  Systems for Molecular Biology}, 1:\penalty0 328--336, 1993.

\bibitem[Sim{\~a}o(2026)]{subtilis2026}
Eug{\'e}nio Sim{\~a}o.
\newblock Thermodynamic constraints drive hierarchical preemption in cellular
  decision-making: A hybrid petri net framework with application to
  \textit{Bacillus subtilis} sporulation.
\newblock \emph{arXiv preprint arXiv:2601.04335}, 2026.
\newblock URL \url{https://arxiv.org/abs/2601.04335}.
\newblock Demonstrates 16$\times$ ATP reduction in stress-induced sporulation
  through hierarchical preemption.

\bibitem[Sim{\~a}o et~al.(2005)Sim{\~a}o, Remy, Thieffry, and
  Chaouiya]{simao2005}
Eug{\'e}nio Sim{\~a}o, Elisabeth Remy, Denis Thieffry, and Claudine Chaouiya.
\newblock Qualitative modelling of regulated metabolic pathways: application to
  the tryptophan biosynthesis in e. coli.
\newblock \emph{Bioinformatics}, 21\penalty0 (Suppl 2):\penalty0 ii190--ii196,
  2005.
