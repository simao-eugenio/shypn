...
%DIF ADD revision_2/main_plos_one_revision2.tex   Sun Jul 19 12:48:52 2026
...
\item $F_t \subseteq P \times T$ defines test arcs (catalysis, non-consuming); test arc enablement requires $M(p) \geq 1$ for all $(p,t) \in F_t$ --- the sensing threshold is uniformly~1 and is not a free parameter of the formalism
