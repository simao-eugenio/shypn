...
%DIF ADD revision_2/main_plos_one_revision2.tex   Sun Jul 19 13:45:26 2026
...
\item SinR/SinI gate: T32 $K_m \approx 52.9\,\mu$M calibrated to match the stochastic bimodal gate dynamics (log-log interpolation across Sweep~C, run\_20260614\_123652); calibration target was gate shape, not the 52\% fraction
\end{itemize}
...
\subsubsection{Sweep~C: Fujita Perturbation Protocol (run\_20260614\_123652)}
...
\begin{figure}[htbp]
    ...
    \caption{%
        ...
        White line: mean sporulation order parameter $\varphi(t)$ averaged over 50 stochastic $\tau$-leaping replicates (run\_20260614\_123652, $N_0 = 1440\,\mu$M, 6-h horizon).
...
%DIFDELCMD < %%%
\textbf{\DIFdel{Case 2: SinR/SinI gate parameters.}} %DIFAUXCMD
\DIFdel{Varying T33 sequestration rate $k_{33}$ and T34 synthesis rate $k_{34}$ by $\pm 20\%$ shifts SinR$_{\text{ss}}$ by $\pm 0.3\,\mu$M relative to the $7.5\,\mu$M threshold.
Natural fraction varies }\DIFdelend \DIFaddbegin \DIFadd{.
}\item \textbf{\DIFadd{SinR/SinI gate ($\pm20\%$):}} \DIFadd{natural }\DIFaddend $40\text{--}64\%$; \DIFdelbegin \DIFdel{the }\DIFdelend gate remains functional\DIFdelbegin \DIFdel{throughout.
}%DIFDELCMD < 
